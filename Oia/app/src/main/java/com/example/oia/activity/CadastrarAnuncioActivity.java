package com.example.oia.activity;
...
import com.example.oia.R;
import com.example.oia.helper.ConfiguracaoFirebase;
import com.example.oia.helper.Permissoes;
import com.example.oia.model.Anuncio;
...
public class CadastrarAnuncioActivity extends AppCompatActivity
    ...
    private ImageView sualogo, imagem2, imagem3;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( resultCode == Activity.RESULT_OK){
            ...
            if( requestCode == 0b1){
                sualogo.setImageURI( imagemSelecionada );
    ...
    private void inicializarComponentes(){
        ...
        sualogo = findViewById(R.id.imageCadastro1);
        imagem2 = findViewById(R.id.imageCadastro2);
        imagem3 = findViewById(R.id.imageCadastro3);
        sualogo.setOnClickListener(this);
